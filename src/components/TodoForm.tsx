...
function TodoForm(props: TodoFormProps) {
  ...
  async function handleLocalisationChange(
  ...
  return (
    ...
    >
      ...
      {step === 5 && nom !== "" && (
        <div>
          <button type="submit" title="Ajouter la tâche à la liste ?">
            &#128190; Ajouter &quot;<b>{nom}</b>&quot; à la liste ?
          </button>
        </div>
      )}
      {step === 5 && nom === "" && (
        <div>
          <button type="submit" title="Tâche KO" disabled>
            <b>
              &#129302; Impossible d&apos;ajouter une tâche sans nom ! &#129302;
            </b>
          </button>
        </div>
      )}
